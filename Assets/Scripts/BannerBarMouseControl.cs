...
public class BannerBarMouseControl : MonoBehaviour
{
    //目标物体  
...
//        topLeft = Camera.main.transform.position.x - (cornerPos.x - Camera.main.transform.position.x);
//        topRight = cornerPos.x;
